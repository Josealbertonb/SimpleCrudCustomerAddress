...
@Section Scripts
    ...
    <script type="text/javascript">
        ...
        function btnAddAdress() {
            ...
            g_Addresses.pushIfNotExist(address);
        ...
        function btnRemove(customerAddressId) {
            //Send the JSON array to Controller.
            var customerAddress = {};
            customerAddress.Customer_Address_Id = customerAddressId;
            if (confirm("Do you really want to delete this address?")) {
                
                $.ajax({
                    type: "POST",
                    url: "/Customers/DeleteCustomerAddress",
