            ...
            <tbody>
                @For Each item In Model.Customer_Address
                    @<tr>
                        ...
                        <td>
                            <input type="button" value="Remove" Class="btn btn-default" onclick="Remove(this);" />
                        </td>
                    </tr>
                Next
            </tbody>
    ...
    <div class="form-row">
        <div Class="form-group">
            <div Class="col-md-10">
                ...
                <input type="button" value="Save Changes" Class="btn btn-success" onclick="btnSave();" />
...
@Section Scripts
    ...
    <script type="text/javascript">
        ...
        function btnAddAdress() {
            ...
            //Add Address to global array
            var address = {};
            address.Line1 = txtLine1.val();
            address.Line2 = txtLine2.val();
            address.City = txtCity.val();
            address.Province = txtProvince.val();
            address.Country = txtCountry.val();
            address.ZipCode = txtZipCode.val();
            address.Address_Type_Id = txtAddressType.val();
            g_Addresses.push(address);
        ...
        function btnSave() {
            ...
            $("#tblAddresses TBODY TR").each(function () {
                ...
                if (row.find("TD").eq(7).html() != "*") {
                    address.Address_Id = row.find("TD").eq(7).html();
                }
            ...
            customer.BrithDate = $("#BrithDate").val();
